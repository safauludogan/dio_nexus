...
import '../home/cubit/home_register_unsuccessful_cubit.dart';
...
abstract class HomeViewModel extends State<HomeView> {
  ...
  late HomeRegisterUnSuccessCubit homeRegisterUnSuccessCubit;
  @override
  void initState() {
    super.initState();
    ...
    homeRegisterUnSuccessCubit =
        BlocProvider.of<HomeRegisterUnSuccessCubit>(context);
  }
}
